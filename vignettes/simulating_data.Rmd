...
+ `direct_SNP_effects_marg`: direct effects of SNPs on traits (marginal)
...
+ `B`: True SNP associations. This isncludes both direct and indirecte effects. B is the expected value of `beta_hat`. 
